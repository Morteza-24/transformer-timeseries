...
from ..models.transformixer import Transformixer
...
class ForecastingExp(LightningModule):
    ...
    def __init__(
        self,
        criterion: nn.Module,
        architecture: BaseModel | xLSTMMixer | Transformixer | PatchTST | TimesNet | iTransformer| xLSTMTime | LSTM | TimeMixer,
        task: Task,
...
class LongTermForecastingExp(ForecastingExp):
    ...
    def __init__(
        self,
        criterion: nn.Module,
        architecture: BaseModel | xLSTMMixer | Transformixer,
        task_options: ForecastingTaskOptions = ForecastingTaskOptions.MULTIVARIATE_2_MULTIVARIATE,
    ) -> None:
        super().__init__(
            criterion,
